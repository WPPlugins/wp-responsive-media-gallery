...
class Responsive_Media_Gallery_Admin {
	...
	function vsz_gallery_add_button_to_views( $which ) {
		...
		echo '<span style="margin-left:5px; float: right;"><input type="button" name="sortorder_value"  onclick="saveSortOrder()"   title="Save Sortorder" class="button button-primary" style="float:right;" value="Save Sortorder"></span>';
