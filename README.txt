...
The responsive photo gallery allows unlimited number of image and video (YouTube, Mp4, Vimeo) as you wish. It allow to add description and title for each image/video.
...
1. Group Gallery (Category wise) Display.
...
= Will Responsive Media Gallery work with my theme? =
...
== Changelog ==
= 1.0.1 =
* Masonry Layout issue has been resolved.
